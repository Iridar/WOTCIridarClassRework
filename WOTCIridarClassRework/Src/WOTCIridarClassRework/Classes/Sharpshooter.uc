...
// Enemy dies to Return Fire: yes
// Enemy does not die to Return Fire: yes
// Enemy kills the shooter: yes

// Enemy does not die to Return Fire and then kills shaprshooter: yes
// Enemy dies to return fire after covering fire overwatch: yes
// Enemy dies to covering fire overwatch: yes
// Enemy does not die to return fire after covering fire overwatch: yes

// triggers multiple times: yes
// triggers on melee: yes
// triggers on AOE attacks: yes
