class X2TargetingMethod_SacrificeSnapToTile extends X2TargetingMethod_PathTarget;

// Taken from Sacrifice Targeting Fix by h4ilst0rm, with permission.
// https://steamcommunity.com/sharedfiles/filedetails/?id=2648230104

// a full copy as the function I want to change uses the private vars
...
function Update(float DeltaTime)
{
	...
	// use the movement path end location instead of the cursor
	NewTargetLocations.AddItem(super.GetPathDestination());
